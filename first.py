...
input_entry.grid(row = 1, column = 2, padx=3)
...
drop_down.grid(row = 1, column = 3,padx=3)
 
# button widget
call_convert = partial(call_convert, result_label, inputNumber)
result_button = tk.Button(root, text ="Temperature Converter", command = call_convert)
result_button.grid(row = 4, columnspan = 4, pady=3)
